...
const data = [
  ...
  new Catalogo('Japanparts Itália', 'http://db.japanparts.it/cjapan/ricerca.jsp?lang=15', v_japanparts_italia),
  new Catalogo('Tecfil','http://www.gruposofape.com.br/tecfil/catalogo/vr_bra/index.php', v_tecfil),
  new Catalogo('Baldwin Filters','http://catalog.baldwinfilter.com/', v_baldwin),
  ...
  new Catalogo('Donaldson Austrália', 'http://www.donaldsontoolbox.com.au/search/crossreference/index/1', v_donald_australia),
  new Catalogo('Wega Original Quality','http://www.filtroswega.com.br/catalogo/busca-geral', v_wega),
